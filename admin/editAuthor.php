          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputName">ID tác giả</label>
                <input type="text" id="idAuthor" class="form-control" value="<?php echo $arr_Author[0];?>"/>
              </div>
              ...
              <div class="form-group">
                <label for="inputName">Tên tác giả mới</label>
     ...
     var idAuthor = $("#idAuthor").val();
	   if(Name !=""){
		 $.ajax({     
	       ...
	       type:'POST',
	       cache:false,
	       data:{'Name':Name, 'newName':newname, 'idAuthor':idAuthor},
	       success:function(kq){
          try{
            var o = JSON.parse(kq);
					 alert(o.Error);
