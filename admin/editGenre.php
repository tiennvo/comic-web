          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="idGenre" class="form-control" value="<?php echo $arr_Genre[0];?>"/>
              </div>
              ...
              <div class="form-group">
                <label for="inputnewName">Tên thể loại mới</label>
     ...
     var idGenre = $("#idGenre").val();
	   if(Name !=""){
		 $.ajax({     
	       ...
	       type:'POST',
	       cache:false,
         data: {'Name': Name, 'newName': newName, 'Title': Title, 'idGenre': idGenre},
	       success:function(kq){
          try {
            var o = JSON.parse(kq);
            alert(o.Error);
            ...
            alert("Error parsing response: " + kq);
          }
	           }
	      })
		 }else{
